...
public class TestGen {
    ...
    public void TestOutputs(){
        ...
        WeatherData weather = new WeatherData(0, 0, 0,
                50, 50, 50, 50.0, 50.0, "hey");
        WeatherData weather2 = new WeatherData(100, 100, 100,
                50, 50, 50, 50.0, 50.0, "hey");
    ...
    public void TestWeather(){
        ...
        ClosetData closet = new ClosetData(source);
        Generator generator = new Generator(closet);
        WeatherData cold = new WeatherData(0, 0, 0,
                50, 50, 50, 50.0, 50.0, "hey");
        ...
        WeatherData warm = new WeatherData(100, 100, 100,
                50, 50, 50, 50.0, 50.0, "hey");
        ...
        WeatherData chill = new WeatherData(60, 60, 60,
                50, 50, 50, 50.0, 50.0, "hey");
